...
public class WaterFillingD extends Dialogue {
	...
	public void start() {
		...
		SkillsDialogue.sendSkillsDialogue(player, SkillsDialogue.MAKE, "How many do you wish to fill?", player.getInventory().getItems().getNumberOf(fill.getEmpty()), new int[] { fill.getEmpty() }, null);
	}
